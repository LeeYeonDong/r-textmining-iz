...
results_df.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/gridsearch_umap_hdbscan03.csv', index=False, encoding='cp949')
...
df_topics.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/df_topics_words0430.csv', index=False, encoding='cp949')
...
topics_over_time.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time0429.csv', index=False, encoding='utf-8')
