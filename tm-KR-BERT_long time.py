...
topic_model = BERTopic(embedding_model=embed_documents, umap_model=umap_model, verbose = True, calculate_probabilities = True)
...
# 토픽 축소
reduced_topics = topic_model.reduce_topics(df['제목'].tolist(), nr_topics=30)
