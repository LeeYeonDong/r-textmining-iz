...
df = df[df['제목'].str.contains('서울|수도권', case=False, na=False)]
...
results_df.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/gridsearch_umap_hdbscan0630.csv', index=False, encoding='cp949')
...
df_topics.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/df_topics_words0630.csv', index=False, encoding='cp949')


# CSV 파일 불러오기
df_topics = pd.read_csv('D:/대학원/논문/소논문/부동산_토픽모델링/df_topics_words0630.csv', encoding='cp949')
...
topics_over_time.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time0630.csv', index=False, encoding='utf-8')

topics_over_time = pd.read_csv('D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time0630.csv', encoding='utf-8')
