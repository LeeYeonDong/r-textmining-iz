...
hdbscan_params = [
    ...
    for s, ms, m in product([20, 30], [None, 5, 10], ['euclidean', 'manhattan'])
]
...
results_df.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/gridsearch_umap_hdbscan01.csv', index=False, encoding='cp949')
